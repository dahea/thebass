...
import basses from './images/basses.jpg'; 
        ...
        <div className="site-wrapper">
          <div className="site-limit">
            <div className="offset-box-wrapper right bio">
              <div className="text-wrapper">
                ...
                <p>Her basslines deliver a catchy and driving groove that adds a dynamic element to songs. Her basslines are melodic and punchy, filled with counter melodies that are heavily influenced by latin jazz, blues, and rock.</p>
          ...
          <div className="site-limit">
            <div className="offset-box-wrapper image-wide left gear">
              <div className="img-wrapper">
                <img src={basses} alt="DaHea An - NYC based bassist - home studio" />
              </div>
              <div className="text-wrapper">
                <h2>
                  Basses & amps
